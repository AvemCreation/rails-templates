...
run 'rm -rf vendor'
run 'curl -L https://github.com/DonatienRolland/stylesheets/archive/master.zip > stylesheets.zip'
...
run 'curl -L https://raw.githubusercontent.com/AvemCreation/awesome-navbars/master/templates/_navbar_wagon.html.erb > app/views/shared/_navbar.html.erb'
